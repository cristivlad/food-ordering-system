...
import org.example.domain.ports.output.repository.CustomerRepository;
import org.example.domain.ports.output.repository.OrderRepository;
import org.example.domain.ports.output.repository.RestaurantRepository;
...
public class OrderCreateCommandHandler {
    ...
    public OrderCreateCommandHandler(OrderDomainService orderDomainService, OrderRepository orderRepository, CustomerRepository customerRepository,
                                     RestaurantRepository restaurantRepository, OrderDataMapper orderDataMapper, ApplicationDomainEventPublisher applicationDomainEventPublisher) {
    ...
    private Order saveOrder(Order order) {
        ...
        log.info("Order is saved with id: {}", save.getId().getValue());
        return save;
    }
}
